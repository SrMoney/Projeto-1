...
function checkInputs () {
    ...
    if (usernameValue === "") {
        setErrorFor(username, "O nome de usuario eh obrigatorio.");
    } else {
        setSuccessFor(username);
    }

    if (emailValue === "") {
        setErrorFor(email, "O email eh obrigatorio");
    ...
    if (passwordConfirmationValue === "") {
        setErrorFor(passwordConfirmation, "A confirmacao de senha eh obrigatoria")
